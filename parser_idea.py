...
class ASTParsser:
    ...
    def read(self):
        ...
        if self.current_token.type in [Tokernizer.TokenType.ID, Tokernizer.TokenType.INT,
            ...
            terminalNode = Node( "<"+str(self.current_token.type.value)+":"+  str(self.current_token.value)+">")
        ...
        if self.current_token.value in  ['true', 'false', 'nil', 'dummy']:
            stack.append(Node(self.current_token.value))
    ...
    def buildTree(self, token, ariness):
        ...
        while ariness > 0:
            ...
            child = stack[-1]
            stack.pop()
            # Assuming pop() is a function that returns an Node
